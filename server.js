...
function play(sessionId, ws, sdpOffer, callback) {
  ...
  getKurentoClient(function(error, kurentoClient) {
      ...
      kurentoClient.create('MediaPipeline', function(error, pipeline) {
          ...
          createPlayMediaElements(pipeline, ws, function(error, webRtcEndpoint, playerEndpoint) {
              if (error) {
                  pipeline.release();
                  return callback(error);
              }
              ...
              connectPlayerMediaElements(webRtcEndpoint, playerEndpoint, function(error) {
                  if (error) {
                      pipeline.release();
                      return callback(error);
                  }
...
function createPlayMediaElements(pipeline, ws, callback) {
  var playerParams = {
    networkCache: 0,
    uri: 'file:///tmp/screen.webm'
  };
    ...
    pipeline.create('WebRtcEndpoint', function(error, webRtcEndpoint) {
        ...
        pipeline.create('PlayerEndpoint', playerParams, function(error, playerEndpoint) {
          if (error) {
              return callback(error);
          }
...
function connectPlayerMediaElements(webRtcEndpoint, playerEndpoint, callback) {
